...
ALLOWED_HOSTS = ['boutique-ado-practice-app.herokuapp.com', 'localhost']
...
# EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend' Commented out as paart of gmail config set up for emails 

ACCOUNT_AUTHENTICATION_METHOD = 'username_email' # tells allauth want to allow authentication using username or emails
ACCOUNT_EMAIL_REQUIRED = True
ACCOUNT_EMAIL_VERIFICATION = 'mandatory'
ACCOUNT_SIGNUP_EMAIL_ENTER_TWICE = True
ACCOUNT_USERNAME_MIN_LENGTH = 4
LOGIN_URL = '/accounts/login/'
LOGIN_REDIRECT_URL = '/' # upon login will be redirected to homepage
...
if 'USE_AWS' in os.environ:
    # Cache control - Telling browser its ok to cache static files for a long time as dont change much 
    # and will improve performance for users
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'boutique-ado-practice-app'
